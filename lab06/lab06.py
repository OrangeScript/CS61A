...
class Account:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.transaction_num,before,self.balance))
    ...
    def withdraw(self, amount):
        ...
        self.transactions.append(Transaction(
            self.transaction_num,self.balance,self.balance if self.balance<amount else self.balance-amount))
        self.transaction_num+=1
